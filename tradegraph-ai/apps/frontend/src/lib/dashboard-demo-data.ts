...
export const performanceSeries = [
  222400, 224100, 223600, 227800, 229900, 228700, 233200, 236800, 235400,
  239100, 241700, 240900, 245300, 248620,
];
...
export const signals: DashboardSignal[] = [
  {
    ...
    summary:
      "Momentum and volume remain constructive, while elevated volatility limits conviction.",
  },
  {
    id: "sig-2",
    asset: "Microsoft",
    ...
    summary:
      "Price is consolidating near resistance with stable fundamentals and neutral short-term momentum.",
  },
  {
    id: "sig-3",
    asset: "EUR / USD",
    ...
    price: 1.0842,
    type: "Bearish",
    target: "1.0710–1.0760",
    confidence: 73,
    risk: "High",
    horizon: "3–7 days",
    createdAt: "1 hr ago",
    summary:
      "Short-term trend weakened after a failed breakout; macro-event risk remains material.",
  },
  {
    id: "sig-4",
    asset: "S&P 500 ETF",
    ...
    createdAt: "2 hrs ago",
    summary:
      "Breadth is mixed and index momentum is positive but extended relative to its recent range.",
  },
  {
    id: "sig-5",
    asset: "Apple",
    ...
    createdAt: "3 hrs ago",
    summary:
      "Relative strength improved with supportive volume, though the price remains close to resistance.",
  },
  {
    id: "sig-6",
    asset: "US Treasury ETF",
    ticker: "TLT",
    price: 93.46,
    type: "Watch",
    target: "$91–$96",
    ...
    createdAt: "5 hrs ago",
    summary:
      "Rate sensitivity dominates the setup; trend confirmation is not yet present.",
  },
];
...
export const demoAlerts: DemoAlert[] = [
  {
    ...
    category: "Risk",
    asset: "EUR/USD",
    condition: "Volatility score above 70",
    status: "Triggered",
    created: "Jul 23, 2026",
  ...
  },
  {
    ...
    category: "Signal",
    asset: "MSFT",
    condition: "Signal changes to Bullish",
    status: "Active",
    created: "Jul 20, 2026",
    lastTriggered: "Never",
    channel: "Email + in-app",
  },
  {
    ...
    asset: "S&P 500",
    condition: "High-impact macro event",
    status: "Paused",
    created: "Jul 18, 2026",
