...
const messages = {
  en: {
    ...
    "explorer.description": "Filter directed trade flows, review annual change, and compare partner and product composition without losing your selection.",
    ...
    "explorer.error": "Explorer data is unavailable. Confirm that the API is online and an active dataset has been imported.",
    ...
    "explorer.interactiveHint": "Hover for exact values. Drag or scroll the timeline to zoom.",
    ...
    "explorer.topPartnersCaption": "Highest-value partners for the selected direction and period",
    "explorer.topProducts": "Top products",
    "explorer.topProductsCaption": "Highest-value HS6 products for the selected flows",
    "explorer.name": "Name",
    "explorer.howToRead": "How to read this analysis",
    "explorer.methodNote": "Values are aggregated from the active dataset after applying every visible filter. Missing quantities are not treated as zero. Year-over-year change is unavailable when the previous value is missing or zero.",
    "forecast.eyebrow": "Statistical decision support",
    "forecast.title": "Trade forecast",
    "forecast.description": "Compare historical observations, the retained moving-average baseline, and the active project-trained model. Forecasts are estimates, not guaranteed future values.",
    ...
    "forecast.error": "The selected lane may have insufficient history, or the active model artifact may be unavailable. Try another lane or review data health.",
    ...
    "supplier.description": "Rank potential exporters using transparent capacity, growth, stability, relationship, unit-value, and diversification components—not one unexplained score.",
    ...
    "supplier.error": "Candidates could not be ranked. Verify the importer, product, and active data coverage.",
    "supplier.empty": "No exporters meet the positive-trade and minimum-history rules.",
  },
  ru: {
    "language.label": "Язык",
    ...
    "explorer.description": "Фильтруйте направленные торговые потоки, изучайте годовые изменения и сравнивайте структуру партнёров и товаров без потери выбранных параметров.",
    ...
    "explorer.error": "Данные анализа недоступны. Убедитесь, что API работает и активный набор данных импортирован.",
    ...
    "explorer.interactiveHint": "Наведите для точных значений. Перетаскивайте или прокручивайте шкалу времени для масштабирования.",
    "explorer.observations": "Показано годовых наблюдений: {count}.",
    "explorer.adjust": "Измените или очистите фильтры, чтобы найти торговые потоки.",
    "explorer.topPartners": "Ведущие партнёры",
    "explorer.topPartnersCaption": "Партнёры с наибольшей стоимостью за выбранный период",
    "explorer.topProducts": "Ведущие товары",
    "explorer.topProductsCaption": "Товары HS6 с наибольшей стоимостью в выбранных потоках",
    "explorer.name": "Название",
    "explorer.howToRead": "Как читать этот анализ",
    "explorer.methodNote": "Значения агрегируются из активного набора данных с учётом всех видимых фильтров. Отсутствующий объём не считается нулём. Изменение год к году недоступно, если предыдущее значение отсутствует или равно нулю.",
    "forecast.eyebrow": "Статистическая поддержка решений",
    "forecast.title": "Прогноз торговли",
    "forecast.description": "Сравните исторические наблюдения, базовый прогноз скользящего среднего и активную модель, обученную на данных проекта. Прогнозы являются оценками, а не гарантией будущих значений.",
    ...
    "forecast.error": "Для выбранного потока может быть недостаточно истории либо артефакт активной модели недоступен. Выберите другой поток или проверьте состояние данных.",
    ...
    "forecast.baselineDetail": "Трёхлетнее скользящее среднее при наличии данных",
    "supplier.eyebrow": "Объяснимый анализ поставок",
    "supplier.title": "Поиск поставщиков",
    "supplier.description": "Ранжируйте потенциальных экспортёров по прозрачным показателям мощности, роста, стабильности, отношений, удельной стоимости и диверсификации — без необъяснимой единой оценки.",
    ...
    "supplier.error": "Не удалось ранжировать кандидатов. Проверьте импортёра, товар и покрытие активных данных.",
    "supplier.empty": "Нет экспортёров, соответствующих требованиям положительной торговли и минимальной истории.",
  },
} as const
