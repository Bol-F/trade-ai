  ...
  return (
    <>
      ...
      <Card className="mt-4 shadow-none">
        {visible.length ? <><Table><TableHeader className="sticky top-16 z-10 bg-card"><TableRow><TableHead className="pl-5">Asset</TableHead><TableHead>Signal</TableHead><TableHead className="text-right">Price</TableHead><TableHead>Target</TableHead><TableHead>Confidence</TableHead><TableHead>Risk / horizon</TableHead><TableHead className="pr-5 text-right"><span className="sr-only">Actions</span></TableHead></TableRow></TableHeader>
