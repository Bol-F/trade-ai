...
const toneStyles: Record<ToastTone, string> = {
  ...
  destructive:
    "border-destructive/30 bg-popover [&_[data-icon]]:text-destructive",
};
const toneIcons = {
  info: Info,
  ...
  return (
    <ToastContext.Provider value={value}>
      ...
      <div
        ...
        className="pointer-events-none fixed inset-x-4 bottom-4 z-[var(--z-toast)] flex flex-col items-end gap-3 sm:left-auto sm:w-[24rem]"
      >
        {messages.map((message) => {
          ...
          return (
            <div
              ...
              role="status"
              className={cn(
                "pointer-events-auto grid w-full grid-cols-[auto_1fr_auto] gap-3 rounded-xl border p-4 text-popover-foreground shadow-elevated",
            ...
            >
              ...
              <button
                ...
                className="grid size-8 place-items-center rounded-md text-muted-foreground hover:bg-accent hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring"
              >
